...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
       ...
       // val viewModelFactory = dataSource.let { SleepTrackerViewModelFactory(it, application) }
        ...
        sleepTrackerViewModel.navigateToSleepQulaity.observe(this, Observer {
        ...
        sleepTrackerViewModel.showSnackbarEvent.observe(this, Observer {
            if (it==true){
                Snackbar.make(
                        activity!!.findViewById(android.R.id.content), getString(R.string.cleared_message), Snackbar.LENGTH_SHORT).show()
